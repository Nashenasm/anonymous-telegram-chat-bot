...
- **هشدار پشتیبان:** در زمان بررسی ۲۵ سپتامبر ۲۰۲۶ برای شاخهٔ production برنامهٔ snapshot خودکار Neon تنظیم نشده بود. پس ماندگاری داده را بدون backup مستقل و آزمون restore تضمین‌شده فرض نکنید.
...
1. برنامهٔ backup منظم PostgreSQL را در سطح Neon یا سرویس backup مستقل خودتان تنظیم کنید. در بررسی فعلی schedule خودکار Neon خالی بود؛ آن را در کنسول خودتان تنظیم کنید و هزینه/نگهداری plan را بررسی کنید.
